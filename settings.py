...
DATABASES = {
    'default': {
        ...
        'NAME': get_env('maps', 'MAPS_DB_NAME', 'PGDATABASE'),                      # Or path to database file if using sqlite3.
        'USER': get_env('maps', 'MAPS_DB_USER', 'OPENSHIFT_POSTGRESQL_DB_USERNAME'),                      # Not used with sqlite3.
        'PASSWORD': get_env('maps', 'MAPS_DB_PASSWORD', 'OPENSHIFT_POSTGRESQL_DB_PASSWORD'),                  # Not used with sqlite3.
        'HOST': get_env('127.0.0.1', 'MAPS_DB_HOST', 'OPENSHIFT_POSTGRESQL_DB_HOST'),                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT':  int(get_env(5432, 'MAPS_DB_PORT', 'OPENSHIFT_POSTGRESQL_DB_PORT')),                     # Set to empty string for default. Not used with sqlite3.
...
#remote workers
local_ip=get_env('127.0.0.1', 'OPENSHIFT_INTERNAL_IP', 'OPENSHIFT_ADVANCED_PYTHON_IP', 'OPENSHIFT_PYTHON_IP')
